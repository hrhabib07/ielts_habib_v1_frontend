/** Display number (Bangladesh local). */
export const SUPPORT_WHATSAPP_DISPLAY = "01612098484";

/** `wa.me` link without + prefix. */
export const SUPPORT_WHATSAPP_WA_ME = "8801612098484";
