...
export const MISSION_ONE_PAYWALL_COPY = {
  ...
  gapBody:
    "তুমি বেসিক বাক্য সাজানো শিখেছো। কিন্তু ফ্লুয়েন্টলি নিজেকে প্রকাশ করা এখনো বাকি। মিশন ০২ আনলক করে সেই স্কিলগুলো আয়ত্ত করো।",
  unlockHow: "কীভাবে আনলক করব?",
  socialProof: "ইতিমধ্যেই ৪০+ লার্নার ফুল জার্নি শুরু করেছেন",
  cta: "ফুল জার্নি আনলক করো",
  clarifier:
    "একবার পেমেন্টেই বাকি ২০টি মিশন এবং সম্পূর্ণ গাইডেন্স ৪৫ দিনের জন্য আনলক হবে।",
  later: "পরে দেখব",
