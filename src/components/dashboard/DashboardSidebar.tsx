...
export function DashboardSidebar({ role, isMobileOpen, onClose }: DashboardSidebarProps) {
  ...
  return (
    <>
      ...
      />
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r border-zinc-200 bg-white transition-transform duration-300 lg:z-30 lg:translate-x-0 ${
      ...
      >
        <div className="flex h-16 shrink-0 items-center justify-between border-b border-zinc-200 px-6">
          <div className="flex items-center gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-zinc-900">IELTS Habib</p>
