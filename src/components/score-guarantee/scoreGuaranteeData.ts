export const SCORE_GUARANTEE_TAGLINE =
...
export const SCORE_GUARANTEE_CRITERIA = [
  ...
  },
  {
    ...
    description:
      "Your Water Level (Readiness Meter) must reach 90% or higher on Gamlish, based on our internal AI-evaluated assessments.",
...
export const SCORE_GUARANTEE_WHY_90_TITLE = "Why 90%?";
export const SCORE_GUARANTEE_WHY_90_BODY =
...
export const SCORE_GUARANTEE_LEGAL_NOTE =
  "The Gamlish Score Guarantee™ applies only when all eligibility conditions are met and verified by our team. Official IELTS results and Gamlish activity logs may be required. Gamlish is not affiliated with IDP, British Council, or Cambridge Assessment English.";
