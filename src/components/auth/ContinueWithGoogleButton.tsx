...
import { getGoogleOAuthStartUrl } from "@/src/lib/google-oauth";
...
const COPY = {
  en: {
    ...
    save: "Save progress with Google",
  },
  bn: {
    continue: "Google দিয়ে চালিয়ে যান",
    save: "Google দিয়ে প্রগ্রেস সেভ করুন",
  },
} as const;
...
export function ContinueWithGoogleButton({
  ...
  const href = useMemo(() => {
    ...
    return getGoogleOAuthStartUrl({
      demoSessionId: sid,
      returnTo: returnTo ?? null,
    });
  }, [demoSessionId, returnTo]);
