...
/**
 * Legacy right-side hero visual: mission-card mock.
 * Kept intact for instant rollback via USE_HERO_TRANSLATE_CINEMA=false.
 */
export function GuestHeroMissionCardVisual({
  className,
}: {
  className?: string;
}) {
