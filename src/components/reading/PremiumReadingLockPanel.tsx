...
> = {
  practice_test: {
    ...
    bn: {
      ...
      body: "আপনার ফ্রি অংশ সম্পন্ন করার জন্য ধন্যবাদ। এই ধাপে আপনি পেইড টিয়ারের শুরুতে এসেছেন। লেভেল 2-এ ফ্রি ট্র্যাকে সাধারণত প্র্যাকটিস টেস্ট 1 পর্যন্ত থাকে। বাকি প্র্যাকটিস টেস্ট, পরবর্তী ধাপ ও ফাইনাল ইভ্যালুয়েশন আনলক না করলে এই লেভেল সম্পূর্ণ হয় না। আপনার কাঙ্ক্ষিত ব্যান্ড স্কোরের দিকে এগিয়ে যেতে সাবস্ক্রাইব করুন।",
    },
  },
  step_content: {
    en: {
  ...
  level: {
    ...
    bn: {
      ...
      body: "আপনি ফ্রি ট্র্যাকের শেষে এসেছেন। সম্পূর্ণ লেভেল, সব প্র্যাকটিস টেস্ট ও ফাইনাল ইভ্যালুয়েশন প্রিমিয়াম সদস্যদের জন্য। এই লেভেল ও সম্পূর্ণ 21-লেভেল কোর্স আনলক করতে সাবস্ক্রাইব করুন।",
    },
  },
};
